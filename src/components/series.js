import poster1 from '../img/series/fleabag.jpg'
import poster2 from '../img/series/gambito.jpg'
import poster3 from '../img/series/xmen.jpg'
  ...
  return (
    <div>
      <h2 className="flex justify-center text-base font-semibold text-zinc-900 dark:text-zinc-100">
        ...
        <span className="ml-3">Last TV shows I've watched</span>
      </h2>
      <div className="mt-6">
        <div className="carrusel-posters">
          ...
          <div className="posters poster-1 shadow-xl z-10">
              <Tippy content="Fleabag" theme={'light-border'} arrow={false} animation={'shift-toward'}>
                <img src={poster1} alt="tv show" />
              </Tippy>
            </div>
            <div className="posters poster-2 shadow-2xl -rotate-5">
              <Tippy content="The Queen's Gambit" theme={'light-border'} arrow={false} animation={'shift-toward'} >
                <img src={poster2} alt="tv show" />
              </Tippy>
            </div>
            <div className="posters poster-3 shadow-2xl rotate-4">
              <Tippy content="X-Men 97" theme={'light-border'} arrow={false} animation={'shift-toward'} >
                <img src={poster3} alt="tv show" />
              </Tippy>              
            </div>
          {/* </a> */}
        </div>
      </div>
      <h5 className="flex pt-2 justify-center text-xs font-normal text-zinc-900 dark:text-zinc-100">Shows last update: May 2024</h5>
    </div>
