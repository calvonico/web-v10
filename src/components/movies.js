import poster1 from '../img/films/deadpool3.jpg'
import poster2 from '../img/films/banshees.jpg'
import poster3 from '../img/films/dune.jpg'
...
export default function Movies() {
  ...
  return (
    <div>
      ...
      <h5 className="flex pt-2 justify-center text-xs font-normal text-zinc-900 dark:text-zinc-100">Movies last update: August 2024</h5>
    </div>
