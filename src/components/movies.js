import poster1 from '../img/films/thunderbolts.jpg'
import poster2 from '../img/films/captainamerica4.jpg'
import poster3 from '../img/films/sustancia.jpg'
...
export default function Movies() {
  ...
  return (
    <div>
      ...
      <h5 className="flex pt-2 justify-center text-xs font-normal text-zinc-900 dark:text-zinc-100">Movies last update: July 2025</h5>
    </div>
