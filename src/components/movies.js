import poster1 from '../img/films/intensamente2.jpg'
import poster2 from '../img/films/pikachu.jpg'
import poster3 from '../img/films/wolfs.jpg'
...
export default function Movies() {
  ...
  return (
    <div>
      ...
      <h5 className="flex pt-2 justify-center text-xs font-normal text-zinc-900 dark:text-zinc-100">Movies last update: January 2025</h5>
    </div>
