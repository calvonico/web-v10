import poster2 from '../img/films/deadpool3.jpg'
import poster3 from '../img/films/banshees.jpg'
import poster1 from '../img/films/wolfs.jpg'
...
export default function Movies() {
  ...
  return (
    <div>
        ...
        <div className="carrusel-posters">
          ...
          <div className="posters poster-1 shadow-xl z-10">
            ...
            <div className="posters poster-3 shadow-2xl rotate-4">
              <Tippy content="The Banshees of Inisherin &ndash; ★★★★" theme={'light-border'} arrow={false} animation={'shift-toward'} >
      ...
      <h5 className="flex pt-2 justify-center text-xs font-normal text-zinc-900 dark:text-zinc-100">Movies last update: November 2024</h5>
    </div>
