  ...
  return (
    <div className="contenido-bio">
      ...
      <div className="bio dark:text-zinc-100">
        ...
        <p className="mt-3">
        For the last 12 years my work has consisted of marketing design: building creatives for email, social media, websites, and more. I have also developed several websites, UI for mobile applications, and have mentored and led teams of designers.
        </p>
        <p className="mt-3">
