  ...
  return (
    <div className="contenido-bio">
      ...
      <div className="bio dark:text-zinc-100">
        ...
        <p className="mt-1">
          I'm a entrepeneur, designer and developer passionate about building things that help people. Born and raised in Buenos Aires, Argentina, now based in beautiful Porto, Portugal.
        </p>
        <p className="mt-3">
